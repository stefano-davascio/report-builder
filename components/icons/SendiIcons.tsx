...
// Figma: grid (1133:104474) — the "modules / widgets" 2×2 grid.
export function IconModules({ className, size = 20, color = 'currentColor' }: IconProps) {
  return (
    <FigmaIcon size={size} color={color} nativeW={19.5} nativeH={19.5} className={className}>
      <path d="M7.75 0.75H0.75V7.75H7.75V0.75Z" {...S} />
      <path d="M18.75 0.75H11.75V7.75H18.75V0.75Z" {...S} />
      <path d="M18.75 11.75H11.75V18.75H18.75V11.75Z" {...S} />
      <path d="M7.75 11.75H0.75V18.75H7.75V11.75Z" {...S} />
    </FigmaIcon>
  );
}
